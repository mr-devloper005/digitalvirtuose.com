...
const heroClasses = {
  'search-first': {
    section: 'border-b border-border bg-[linear-gradient(180deg,#f4faf7_0%,#ffffff_48%,#f4faf7_100%)] text-foreground',
    overlay: 'bg-[radial-gradient(circle_at_top_left,rgba(176,228,204,0.35),transparent_30%),radial-gradient(circle_at_top_right,rgba(40,90,72,0.08),transparent_28%)]',
    grid: 'lg:grid-cols-[1.08fr_0.92fr]',
    card: 'border border-border bg-card/95 shadow-[0_28px_90px_rgba(9,20,19,0.08)]',
    title: 'text-foreground',
    body: 'text-muted-foreground',
    badge: 'bg-primary text-primary-foreground',
    primary: 'bg-primary text-primary-foreground hover:bg-primary/90',
    secondary: 'border border-border bg-card text-foreground hover:bg-secondary/80',
  },
  'spotlight-split': {
  ...
  'gallery-mosaic': {
    section: 'border-b border-[#0f1f1c] bg-[linear-gradient(180deg,#091413_0%,#0f1f1c_45%,#122922_100%)] text-white',
    overlay: 'bg-[radial-gradient(circle_at_top_left,rgba(64,138,113,0.2),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(176,228,204,0.12),transparent_28%)]',
    grid: 'lg:grid-cols-[0.95fr_1.05fr]',
    card: 'border border-white/10 bg-[#0f1f1c]/85 shadow-[0_30px_110px_rgba(9,20,19,0.45)] backdrop-blur-xl',
    title: 'text-white',
    body: 'text-[#b0e4cc]/85',
    badge: 'bg-[#408a71] text-[#f4faf7]',
    primary: 'bg-[#408a71] text-[#f4faf7] hover:bg-[#285a48]',
